...
public class Camera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherOption.setAdapter(adapter);
    ...
    public void onSaveItem(View view) {
        ...
        String spinnerText = otherOption.getSelectedItem().toString();
        String category;
        ...
        if (label.matches("")) {
            ...
            toast.show();
            return;
        } else if (predictions.getCheckedRadioButtonId() == -1 && spinnerText =="Select Category") {
            String text = "Please select item category";
            Toast toast = Toast.makeText(context, text, duration);
            toast.show();
            return;
        } else if (MainActivity.clothingCollection.clothingItemDao().getItemByNameInt(label) == 1) {
            ...
            try {
             ...
             //if radio button is selected get category else get category from spinner.
            if (predictions.getCheckedRadioButtonId() != -1) {
                category = (String) selectedCategory.getText();
            }
            else {
                category = otherOption.getSelectedItem().toString();
            }
    ...
    protected void onActivityResult(int requestCode,int resultCode, Intent data){
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            chooseCat.setVisibility(View.VISIBLE);
